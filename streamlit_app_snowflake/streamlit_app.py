...
#st.image("images/home_img.jpeg", caption='', use_container_width=True)
...
#st.image("images/omdena_website.jpeg", caption='', use_container_width=False)

st.header("Estimation")

# Few facilities id for testing
facility_id = (
    '1453',
    '1175',
    '1176',
...
if hit:
    X = pd.DataFrame([[ccsr_procedure, discharge_year, age, type_admission, 
             ...
             columns=['CCSR_PROCED_DESCRIPTION', 'DISCHARGE_YEAR', 'AGE_GROUP', 'TYPE_OF_ADMISSION', 
    ...
    X = X.drop(['remainder__DISCHARGE_YEAR', 'remainder__TOTAL_CHARGES'], axis=1)
